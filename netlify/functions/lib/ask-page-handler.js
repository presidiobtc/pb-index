...
<meta name="robots" content="noindex"><title>Shared answer not found | PB Media Archive</title></head>
...
exports.handler = async function handler(event) {
  if (!new Set(["GET", "HEAD"]).has(event?.httpMethod)) {
    return html(405, "Method not allowed.", { "cache-control": "no-store", allow: "GET, HEAD" });
  }
